...
class PLUGIN_testpkg_resizetest:
	...
	def movet(self, xoff, yoff):
		...
		self.widbox=self.frametoup[0]
		self.framerect=self.frametoup[1]
	#optional resize method called on right click.
...
SDAPPLUGREF=PLUGIN_testpkg_resizetest
#plugin execname
SDAPNAME="testpkg_resizetest"
SDAPLABEL="Resize test"
